      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-lg">AirTrack</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-md">
              Real-time air quality monitoring for a healthier world. Track pollution levels, 
              explore interactive maps, and stay informed about the air you breathe.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2024 AirTrack. Built with ❤️ for cleaner air.
          </p>
          <div className="flex items-center space-x-4 mt-4 sm:mt-0">
            <a 
              href="https://github.com/disdin" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
              aria-label="GitHub"
            ...
            <a 
              href="https://www.linkedin.com/in/sidhant-bahri/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
              aria-label="LinkedIn"
